...
function ProtectedApplication() {
  ...
  const journalMatch = location.pathname.match(/^\/journal\/([A-Za-z0-9-]+)$/);
  ...
  if (journalMatch) return <TradeReviewPage tradeId={journalMatch[1]} />;
