...
import DayTradingLabPage from "./pages/DayTradingLabPage";
...
function ProtectedApplication() {
  ...
  const page: AppPage = location.pathname === "/backtesting" ? "backtesting" : location.pathname === "/paper-trading" ? "paper-trading" : location.pathname === "/day-trading-lab" ? "day-trading-lab" : location.pathname === "/forward-validation" ? "forward-validation" : location.pathname === "/latest-signals" ? "latest-signals" : location.pathname === "/learning" ? "learning" : location.pathname === "/validation" ? "validation" : location.pathname === "/evidence" ? "evidence" : location.pathname === "/beta-guide" ? "beta-guide" : location.pathname === "/feedback" ? "feedback" : location.pathname === "/beta-invites" ? "beta-invites" : "dashboard";

  function navigatePage(nextPage: AppPage) {
    routerNavigate(nextPage === "dashboard" ? "/dashboard" : nextPage === "backtesting" ? "/backtesting" : nextPage === "paper-trading" ? "/paper-trading" : nextPage === "day-trading-lab" ? "/day-trading-lab" : nextPage === "forward-validation" ? "/forward-validation" : nextPage === "latest-signals" ? "/latest-signals" : nextPage === "learning" ? "/learning" : nextPage === "validation" ? "/validation" : nextPage === "evidence" ? "/evidence" : nextPage === "beta-guide" ? "/beta-guide" : nextPage === "beta-invites" ? "/beta-invites" : "/feedback");
  }
  ...
  if (page === "day-trading-lab") {
    return <DayTradingLabPage onNavigate={navigatePage} />;
  }
