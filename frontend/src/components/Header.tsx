function Header() {
  return (
    <header className="flex h-20 items-center justify-between border-b border-slate-800 bg-slate-950 px-5 sm:px-8">
      <div>
        <p className="text-sm font-medium text-slate-400">Market overview</p>
        <h1 className="text-xl font-semibold tracking-tight text-white sm:text-2xl">Scanner Dashboard</h1>
      </div>
