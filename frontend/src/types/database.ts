...
export type UserSettings = { user_id: string; default_account_size: number; default_risk_percent: number; preferred_currency: string; theme: string; experience_mode: "beginner" | "advanced" };
